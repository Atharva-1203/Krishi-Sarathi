# Krishi Sarathi V5: Final Scale-Up Report

This report documents our V5 data scale-up analysis, re-audits, benchmarking, and decision logs.
...
## 2. Datasets Usable
- **For training the predictor**: **V3 crop recommendation dataset** (2,200 records). 
- **For visual map observatory displays**: All datasets (779k Soil Cards, IMD weather, and DES production summaries are fully integrated).
...
## 11. Bias Analysis
- **Crop Bias**: V3.1 training set has a uniform class distribution (100 rows per crop, 4.4594 bits of Shannon entropy, 1.0 imbalance ratio). 
...
- **Duplicate Overlap**: Near-duplicates between train/test splits = 0 at distance 0.02.
...
2. Start the FastAPI development server: `python backend/app/start_server.py`.
