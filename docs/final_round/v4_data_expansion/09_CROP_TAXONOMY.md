# Crop Taxonomy & Mapping Standards

This document establishes the crop categorization standards and validation criteria for model expansion.
...
## 2. Minimum Criteria for Class Ingestion
