...
This report evaluates class entropy, geographic concentration skews, and simulated target dominance.

---

## 1. Class Entropy Comparisons
...
- **Biased V4/V5 Candidate (4,513 Rows)**:
...
- **Biased V4 Candidate Model**: Recommends Sugarcane in **24.50%** of all test cases.
