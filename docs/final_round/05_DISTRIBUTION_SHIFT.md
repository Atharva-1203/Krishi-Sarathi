# Krishi Sarathi: Distribution Shift & Divergence Analysis

This report profiles the distribution divergence between the 2,200 training dataset and the 7.9 lakh government database.

---

## 1. Feature Distribution Comparison

We calculated summary percentiles for continuous parameters:
