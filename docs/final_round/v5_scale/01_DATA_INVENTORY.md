# Data Inventory Report (V5 Scale-Up)

This document registers the complete data assets inventory currently present in the Krishi Sarathi workspace.

---

## 1. Core Data Assets

### A. V3.1 Predictor Training Set
